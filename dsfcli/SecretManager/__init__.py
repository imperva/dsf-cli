...
def secret_manager_parse(subparsers):
    ...
    secret_manager_create_parser = secret_manager_subparsers.add_parser('create', help='Create a new data source.',
    ...
    secret_manager_read_parser = secret_manager_subparsers.add_parser('read', help='Retrieve data source details',
                                                               usage='dsfcli [options] secret_manager get secret_manager_id')
    secret_manager_read_parser.add_argument('--id', help='The secret_manager ID.')
    secret_manager_read_parser.set_defaults(func=read)

    secret_manager_update_parser = secret_manager_subparsers.add_parser('update', help='Update an existing data source.',
                                                                  usage='dsfcli [options] secret_manager get secret_manager_id')
    ...
    secret_manager_delete_parser = secret_manager_subparsers.add_parser('delete', help='Delete data source.',

...
def data_source_parse(subparsers):
    data_source_parser = subparsers.add_parser('data_source',
                                               help='Create and manage policies for your account using the API.',
    ...
    data_source_read_parser = data_source_subparsers.add_parser('read', help='Retrieve data source details',
                                                               usage='dsfcli [options] data_source get data_source_id')
    data_source_read_parser.add_argument('--id', help='The data_source ID.')
    data_source_read_parser.set_defaults(func=read)

    data_source_update_parser = data_source_subparsers.add_parser('update', help='Update an existing data source.',
                                                                  usage='dsfcli [options] data_source get data_source_id')
    ...
    data_source_delete_parser = data_source_subparsers.add_parser('delete', help='Delete data source.',
